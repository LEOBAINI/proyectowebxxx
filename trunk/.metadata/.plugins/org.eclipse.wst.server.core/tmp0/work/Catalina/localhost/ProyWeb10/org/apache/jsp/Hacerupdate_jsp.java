 ...
 * Generated at: 2013-03-05 03:39:31 UTC
...
if(!periodoEstaAboCerr.equals("CERRADO")){//si el periodo esta abierto
	...
	if(session.getAttribute("esEdicion")!=null){//si es para editar entre aquí
      ...
      out.write("\t\t\t\t document.location=(\"CargaDiaria.jsp\");//redireccion \r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t</script>");
      ...
      out.write("<script type=\"text/javascript\">alert(\"Hubo un problema, no se cargaron los datos\");\r\n");
      out.write("\t\t\t\t document.location=(\"CargaDiaria.jsp\");//redireccion \r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t</script>");
