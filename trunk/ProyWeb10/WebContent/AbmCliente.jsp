...
<body bgcolor="#E6E6E6">
<a>Bienvenido al Alta,Baja,Modificación de Clientes.</a><br>
...
<form name="alta" action="AbmCommitter.jsp" method="post">
	...
	<br><br><br>
	<a>Se sugiere que no modifique el numero de cliente, a menos que lo necesite, pero si lo hace, coloque un número mayor al sugerido. </a>
<% 
}
