...
<body bgcolor="#E6E6E6">
<a>Bienvenido al Alta,Baja,Modificación de Tareas.</a><br>



<%
session.setAttribute("solicitaAbm", "AbmTarea");//ÉSTE SETEO ESTARÁ EN TODOS LOS JSP DE ABM PARA INDICAR AL ABMCOMMITER LA ACCION CORRESPONDIENTE
...
{ out.println("Eligió dar de alta una nueva tarea, complete los campos. ");
%>
...
<form name="alta" action="AbmCommitter.jsp" method="post">
	...
	<br><br><br>
	<a>Se sugiere que no modifique el numero de tarea, a menos que lo necesite, pero si lo hace, coloque un número mayor al sugerido. </a>
<% 
}
...
%>
<a>Ingrese aquí el nuevo nombre de la tarea</a>
