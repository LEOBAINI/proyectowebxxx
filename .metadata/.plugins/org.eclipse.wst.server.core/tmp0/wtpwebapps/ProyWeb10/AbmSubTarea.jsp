...
<body bgcolor="#E6E6E6">
<a>Bienvenido al Alta,Baja,Modificación de Sub-Tareas.</a><br>



<%
session.setAttribute("solicitaAbm", "AbmSubTarea");//ÉSTE SETEO ESTARÁ EN TODOS LOS JSP DE ABM PARA INDICAR AL ABMCOMMITER LA ACCION CORRESPONDIENTE
...
{ out.println("Eligió dar de alta una nueva Subtarea, complete los campos. ");
%>
...
%>
<a>Ingrese aquí el nuevo nombre de la Subtarea</a>
