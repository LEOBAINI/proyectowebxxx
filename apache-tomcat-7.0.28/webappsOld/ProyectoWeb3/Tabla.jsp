...
matriz=metodos.consultar("SELECT idregistrogral,tarea,subtarea,descripcion,departamento,dnipersonal,cliente,horastrabajadas,tipohora,fecha"+
	...
	matriz=metodos.consultar("SELECT idregistrogral,tarea,subtarea,descripcion,departamento,"+
			"usuario,cliente,horastrabajadas,tipohora,fecha "+
...
for(int i=0;i<matriz.size();i++){
	out.println("<tr>");
	for(int j=0;j<10;j++){//10 son la cantidad de elementos del ancho
